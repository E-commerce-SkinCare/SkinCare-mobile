          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border:
                          Border.all(color: const Color(0XFF9DC08B), width: 6),
                      borderRadius: const BorderRadius.all(Radius.circular(17)),
                    ),
                    clipBehavior: Clip.hardEdge,
                    child: ClipRRect(
              ...
              Row(
                children: [
                  Text(
                    widget.product.name, // استبدال هنا باسم المنتج من الاستجابة
                    style: TextStyle(
                      color: Colors.black87,
                      fontSize: 20.0,
                      fontWeight: FontWeight.bold,
              ...
              Text(
                'price : ${widget.product.price}', // استبدال هنا بسعر المنتج من الاستجابة
                style: TextStyle(
                  color: Colors.black87,
                  fontSize: 18.0,
                  fontWeight: FontWeight.bold,
